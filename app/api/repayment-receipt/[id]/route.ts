...
export async function GET(
  ...
  try {
    ...
    // Get repayment with loan to verify ownership
    ...
    if (repayment.receiptUrls.length === 0) {
    ...
    const receiptUrl = repayment.receiptUrls[index];
    ...
    console.error("Repayment receipt fetch error:", error);
