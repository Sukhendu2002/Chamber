...
export function AuthFrame({ children, title, description }: AuthFrameProps) {
  return (
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-background px-4 py-10">
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-border bg-card shadow-[0_30px_90px_oklch(0.2_0.02_286/0.12)] lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <section className="flex min-h-[38rem] items-center justify-center p-5 sm:p-10">
