...
const THEME_VARS: Record<string, Record<string, string>> = {
  light: {
    "--background": "oklch(0.974 0.007 85)",
    "--foreground": "oklch(0.205 0.012 286)",
    "--card": "oklch(0.995 0.003 85)",
    "--card-foreground": "oklch(0.205 0.012 286)",
    "--popover": "oklch(0.995 0.003 85)",
    "--popover-foreground": "oklch(0.205 0.012 286)",
    "--primary": "oklch(0.558 0.248 289)",
    "--primary-foreground": "oklch(0.985 0.005 285)",
    "--secondary": "oklch(0.947 0.025 291)",
    "--secondary-foreground": "oklch(0.34 0.11 289)",
    "--muted": "oklch(0.95 0.007 80)",
    "--muted-foreground": "oklch(0.49 0.018 286)",
    "--accent": "oklch(0.935 0.035 291)",
    "--accent-foreground": "oklch(0.42 0.18 289)",
    "--destructive": "oklch(0.59 0.225 27)",
    "--border": "oklch(0.895 0.011 82)",
    "--input": "oklch(0.895 0.011 82)",
    "--ring": "oklch(0.62 0.21 289)",
    "--sidebar": "oklch(0.992 0.003 85)",
    "--sidebar-foreground": "oklch(0.245 0.015 286)",
    "--sidebar-primary": "oklch(0.558 0.248 289)",
    "--sidebar-primary-foreground": "oklch(0.985 0.005 285)",
    "--sidebar-accent": "oklch(0.945 0.034 291)",
    "--sidebar-accent-foreground": "oklch(0.42 0.18 289)",
    "--sidebar-border": "oklch(0.91 0.01 82)",
    "--sidebar-ring": "oklch(0.62 0.21 289)",
  },
  dark: {
    "--background": "oklch(0.16 0.018 286)",
    "--foreground": "oklch(0.95 0.008 285)",
    "--card": "oklch(0.205 0.021 286)",
    "--card-foreground": "oklch(0.95 0.008 285)",
    "--popover": "oklch(0.205 0.021 286)",
    "--popover-foreground": "oklch(0.95 0.008 285)",
    "--primary": "oklch(0.72 0.18 289)",
    "--primary-foreground": "oklch(0.16 0.018 286)",
    "--secondary": "oklch(0.275 0.04 289)",
    "--secondary-foreground": "oklch(0.92 0.012 285)",
    "--muted": "oklch(0.245 0.018 286)",
    "--muted-foreground": "oklch(0.71 0.021 285)",
    "--accent": "oklch(0.31 0.075 289)",
    "--accent-foreground": "oklch(0.92 0.02 289)",
    "--destructive": "oklch(0.7 0.19 24)",
    "--border": "oklch(0.34 0.022 286 / 70%)",
    "--input": "oklch(0.34 0.022 286 / 80%)",
    "--ring": "oklch(0.72 0.18 289)",
    "--sidebar": "oklch(0.185 0.02 286)",
    "--sidebar-foreground": "oklch(0.93 0.009 285)",
    "--sidebar-primary": "oklch(0.72 0.18 289)",
    "--sidebar-primary-foreground": "oklch(0.16 0.018 286)",
    "--sidebar-accent": "oklch(0.29 0.055 289)",
    "--sidebar-accent-foreground": "oklch(0.94 0.012 285)",
    "--sidebar-border": "oklch(0.34 0.022 286 / 70%)",
    "--sidebar-ring": "oklch(0.72 0.18 289)",
  },
  "ocean-light": {
...
const THEMES: { key: ThemeKey; label: string; colors: string[] }[] = [
  {
    key: "default",
    label: "Chamber",
    colors: ["#f7f5ef", "#eee9ff", "#6746e8", "#1f1d24"],
  },
  {
    key: "ocean",
    label: "Ocean",
